...
class IvrPrompt(models.Model):
    ...
    keypress  = models.SmallIntegerField(max_length=20, blank=True, null=True)
...
class CallLogEvent(models.Model):
    ...
    cid_e164 = models.CharField(max_length=255, blank=True, null=True)
    called_number = models.CharField(max_length=255, blank=True, null=True)
    event = models.CharField(max_length=255, blank=True, null=True)
    data = models.CharField(max_length=255, blank=True, null=True)
    callduration = models.CharField(max_length=255, blank=True, null=True)
    record_duration = models.CharField(max_length=255, blank=True, null=True)
    total_call_duration = models.CharField(max_length=255, blank=True, null=True)
    ...
    outbound_sid = models.CharField(max_length=255, blank=True, null=True)
